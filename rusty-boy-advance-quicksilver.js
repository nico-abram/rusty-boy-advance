...
(function( root, factory ) {
    if( typeof define === "function" && define.amd ) {
        ...
        Rust.rusty_boy_advance_quicksilver = factory();
    }
}( this, function() {
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "rusty-boy-advance-quicksilver.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "rusty-boy-advance-quicksilver.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'rusty_boy_advance_quicksilver'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'rusty_boy_advance_quicksilver':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_34c14687d9e23083c57485971b5b5b34a5e89e2a": function($0) {
                var o = Module.STDWEB_PRIVATE.acquire_js_reference( $0 );return (o instanceof ProgressEvent && o.type === "loadend");
            },
            ...
            "__cargo_web_snippet_46fc137b34b66249609e431bf7a1a900f92bc53e": function() {
                alert("Invalid ROM");
            },
            ...
            "__cargo_web_snippet_b4173d70d56179a98a903a8f467dedb0a4b98188": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return($1).target.result;})());
            },
            ...
            "__cargo_web_snippet_bb59c4cf492fbc52bb791048c0420d40e9654c5d": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){return($1).readAsArrayBuffer(($2))})());
            },
